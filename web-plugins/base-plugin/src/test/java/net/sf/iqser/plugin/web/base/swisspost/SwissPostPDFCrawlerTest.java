...
public class SwissPostPDFCrawlerTest extends SwissPostCrawlerBase{
	...
	// all links that are bounded by the domain admin.ch
	String simplifyRegex = "\\S+\\.admin.ch\\S+";
	
	// links that are bounded by domain admin.ch, are pdfs or html. If they are html must contain languege info
	String regex = "\\S+admin.ch" 
		+ "((\\S+/e/\\S+\\.html\\S*)|"
		+ "(\\S+/en/\\S+\\.html\\S*)|"
		+ "(\\S+\\.html\\S+lang=en\\S*)|"
		+ "(\\S+\\.pdf)|"
	...
	protected void updateInitParams(Properties initParams) {	
		...
		//initParams.setProperty("start-path", "/dokumentation/gesetz/index.html?lang=en");			
	...
	public void testRegex(){
		...
		String[] examples = new String[]{
				...
				"http://www.admin.ch/index.pdf",
				"http://www.admin.ch/index.PDF",
				"http://www.admin.ch/ch/e/rs/6.html",
				"http://www.admin.ch/ch/e/rs/142_31/index.html",
				"http://www.admin.ch/ch/e/rs/8/814.012.en.pdf"
		};
		...
		String[] negExamples = new String[]{				
				...
				"http://www.fdfa.admin.ch/index.html?p1=v1",
				"http://www.fdfa.admin.ch/index.html?lang=de",
				"http://www.fdfa.admin.ch/index.html?p1=v1&lang=de",
				"http://www.fdfa.admin.ch/index.html?p1=v1&lang=de&p2=v2",
				"http://www.fdfa.admin.ch/ch/d/rs/6.html"
		};
